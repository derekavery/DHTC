...
try{
    ...
    $sql = "SELECT * FROM Card WHERE Card.packID = 4 AND Card.card_lvl = 1";
    ...
    $sql = "UPDATE User SET currency = ($currency - 400)  WHERE User.userID = '$userID'";
    ...
    //Updates user currenct in frontend
    $sql = "SELECT * FROM User WHERE User.userID = '$userID'";
    $result = mysqli_query($conn, $sql);
    $resultArray = mysqli_fetch_assoc($result);
